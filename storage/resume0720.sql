...
--
-- Database: resume
-- Generation Time: 2023-07-20 13:21:16.9570
-- -------------------------------------------------------------
...
CREATE TABLE `resume_experiences` (
  ...
  `year_to` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(1, 2, 'BACHELOR OF FINE ARTS & GRAPHIC DESIGN', '2010-01-01 00:00:00', '2014-01-01 00:00:00', 'Rochester Institute of Technology, Rochester, NY', 'Quia nobis sequi est occaecati aut. Repudiandae et iusto quae reiciendis et quis Eius vel ratione eius unde vitae rerum voluptates asperiores voluptatem Earum molestiae consequatur neque etlon sader mart dila', NULL, NULL),
(2, 2, 'MASTER OF FINE ARTS & GRAPHIC DESIGN', '2015-01-01 00:00:00', '2016-01-01 00:00:00', 'Rochester Institute of Technology, Rochester, NY', 'Qui deserunt veniam. Et sed aliquam labore tempore sed quisquam iusto autem sit. Ea vero voluptatum qui ut dignissimos deleniti nerada porti sand markend', NULL, NULL);

INSERT INTO `resume_experiences` (`id`, `rcid`, `job_title`, `year_from`, `year_to`, `company`, `job_description`, `created_at`, `updated_at`) VALUES
(1, 3, 'Graphic design specialist', '2017', '2018', 'Stepping Stone Advertising, New York, NY', '            <ul>\n              <li>Developed numerous marketing programs (logos, brochures,infographics, presentations, and advertisements).</li>\n              <li>Managed up to 5 projects or tasks at a given time while under pressure</li>\n              <li>Recommended and consulted with clients on the most appropriate graphic design</li>\n              <li>Created 4+ design presentations and proposals a month for clients and account managers</li>\n            </ul>', NULL, NULL),
(2, 3, 'Senior graphic design specialist', '2019', 'Present', 'Experion, New York, NY', '            <ul>\n              <li>Lead in the design, development, and implementation of the graphic, layout, and production communication materials</li>\n              <li>Delegate tasks to the 7 members of the design team and provide counsel on all aspects of the project. </li>\n              <li>Supervise the assessment of all graphic materials in order to ensure quality and accuracy of the design</li>\n              <li>Oversee the efficient use of production project budgets ranging from $2,000 - $25,000</li>\n            </ul>', NULL, NULL);

INSERT INTO `resume_sumaries` (`id`, `rcid`, `name`, `address`, `phone`, `email`, `summary`, `created_at`, `updated_at`) VALUES
(1, 1, 'Alice Barkley', 'Portland par 127,Orlando, FL', '(123) 456-7891', 'alice.barkley@example.com', '<em>Innovative and deadline-driven Graphic Designer with 3+ years of experience designing and developing user-centered digital/print marketing material from initial concept to final, polished deliverable.</em>', NULL, NULL);
